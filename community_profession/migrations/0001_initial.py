# Generated by Django 4.0.4 on 2022-11-17 10:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Time', models.TimeField(default=datetime.datetime(2022, 11, 17, 16, 2, 11, 214459))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Post', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='community_profession.community_post')),
                ('Question', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='community_profession.user_question')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Reply_Time', models.TimeField(default=datetime.datetime(2022, 11, 17, 16, 2, 11, 215456))),
